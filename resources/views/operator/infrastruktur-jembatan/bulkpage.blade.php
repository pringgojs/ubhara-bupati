...
<div class="row">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('operator.infrastruktur-jembatan.bulkvalidate', $data->id) }}" class="btn" data-toggle="tooltip" title="Migrate"><i class="ti ti-check"></i></a>
                        @endif
                        @if($data->status == 'migrated')
                        <a href="{{ route('operator.infrastruktur-jembatan.rollback', $data->id) }}" class="btn" onclick="return confirm('Yakin hapus data?')" data-toggle="tooltip" title="Rollback"><i class="ti ti-trash"></i></a>
                        @endif
                      </td>
                  @endforeach
              </tbody>
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <p class="card-title">Tambah Data Jembatan Sekaligus</p>
            <p class="font-weight-500 card-caption">Menambahkan data baru</p>
            <form method="post" action="{{ url('operator/infrastruktur-jembatan/bulk') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
