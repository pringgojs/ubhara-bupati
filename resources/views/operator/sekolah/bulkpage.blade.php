...
<div class="row">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('operator.sekolah.bulkvalidate', $data->id) }}" class="btn" data-toggle="tooltip" title="Migrate"><i class="ti ti-check"></i></a>
                        @endif
                      </td>
                  @endforeach
              </tbody>
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <p class="card-title">Tambah Data Sekolah Sekaligus</p>
            <p class="font-weight-500 card-caption">Menambahkan data baru</p>
            <a href="{{ url('file_upload/Satuan_Pendidikan.xlsx') }}">
              <button class="btn btn-sm btn-primary">Download Contoh File Sekolah</button>
            </a> 
            <hr>
            <form method="post" action="{{ url('operator/sekolah/bulk') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
