    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title">Master Data Management: Tenaga Kesehatan</p>
            </div>
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
            <p class="card-title">Daftar Tenaga Kesehatan</p>
            </div>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('operator.kesehatan-tenaga.bulkvalidate', $data->id) }}" class="btn"><i class="ti ti-check"></i></a>
                        @endif
                      </td>
                  @endforeach
              </tbody>
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <p class="card-title">Tambah Data Nakes Sekaligus</p>
            <p class="font-weight-500 card-caption">Menambahkan data baru</p>
            <form method="post" action="{{ url('operator/kesehatan-tenaga/bulk') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
