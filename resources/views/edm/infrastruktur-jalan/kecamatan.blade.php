    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title">Executive Dashboard Management Infrastruktur Jalan di Kecamatan {{ $kecamatan->name }}</p>
            </div>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="font-weight-500">Rekapitulasi kondisi Jalan Kabupaten di Kecamatan {{ $kecamatan->name }}</p>
    ...
    <div class="col-md-9 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="font-weight-500 card-caption">Menampilkan data jalan beserta panjang dan statusnya tiap desa. Data yang dihasilkan terupdate secara berkala sesuai dengan hasil survey petugas di lapangan</p>
            <table class="datatable">
                <thead>
                    <td>No.</td>
                    <td>Desa</td>
                ...
                <tr>
                    <td>{{ $counter++ }}</td>
                    <td><a href="{{ url('edm/infrastruktur-jalan/desa',$desa->id) }}" class="caption-with-link">{{ ucwords($desa->name) }}</a></td>
