    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title">Executive Dashboard Management: Setiap Bidang dalam Program</p>
            </div>
...
<div class="row">
    <div class="col-md-9 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <p class="card-title">Persentase Realisasi Tiap Bidang</p>
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
            <p class="card-title">Detail Tiap Bidang</p>
            <p class="font-weight-500 card-caption">Menampilkan Grafik Analisa Capaian untuk Aspek tertentu</p>
            @foreach($programs as $program)
            <p><a href="{{ route('edm.renc-ang.program', ['program_id' => $program->program_id]) }}">{{ $program->program_nama }}</a></p>
            @endforeach
        </div>
    </div>
</div>
...
@section('scripts')
<script>
    $.get('{{ route('graph.renc-ang.semua-program', $bidang_id) }}', function(data){
        console.log(data);
        datasets = [];
        scales = {};
