    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title">Executive Dashboard Management: Setiap Program dalam Urusan</p>
            </div>
...
<div class="row">
    ...
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card">
            ...
            <p><a href="{{ route('edm.renc-ang.bidang', ['bidang' =>$bidang->bidang_id]) }}">{{ $bidang->bidang_nama }}</a></p>
            @endforeach
        </div>
    </div>
</div>
...
@section('scripts')
<script>
    $.get('{{ route('graph.renc-ang.semua-bidang', $urusan_id) }}', function(data){
        console.log(data);
        datasets = [];
        scales = {};
