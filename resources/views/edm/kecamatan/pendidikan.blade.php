...
@section('scripts')
<script>
  $.get('{{ route('graph-kecamatan.pendidikan.cards', $kecamatan->id) }}', function(data){
  ...
  $.get('{{ route('graph-kecamatan.pendidikan.siswa-per-kelas', $kecamatan->id) }}', function(data){
  ...
  $.get('{{ route('graph-kecamatan.pendidikan.negeri-vs-swasta', $kecamatan->id) }}', function(data){
  ...
  $.get('{{ route('graph-kecamatan.pendidikan.guru-vs-murid', $kecamatan->id) }}', function(data){
  ...
  $.get('{{ route('graph-kecamatan.pendidikan.list-sekolah', $kecamatan->id) }}', function(data){
    for(var key in data){
      $('#list-' + key).DataTable({
          data: data[key]
      });
