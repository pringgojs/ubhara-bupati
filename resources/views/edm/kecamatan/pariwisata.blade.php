...
<div class="row">
    ...
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <p class="card-title">Rekap Tempat Wisata Per Desa</p>
            <p class="font-weight-500 card-caption">Menampilkan data rekapitulasi tempat wisata di tiap Desa beserta rata-rata pengunjung per Desa</p>
            <table class="datatable">
              <thead>
                  <td>No.</td>
                  <td>Desa</td>
                  <td>Jumlah Tempat Wisata</td>
              </thead>
              <?php $counterdesa = 1;
              ?>
