    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-title">Executive Dashboard Management Infrastruktur Jembatan di Desa {{ $desa->name }}</p>
            </div>
            <p class="font-weight-500">Menampilkan hasil analisis visual dari data masuk yang berkaitan tentang Jembatan di Desa {{ $desa->name }}</p>
          </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-3 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="font-weight-500">Rekapitulasi kondisi Jembatan Kabupaten di Desa {{ $desa->name }}</p>
    ...
    <div class="col-md-9 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
            <p class="card-title">Grafik Status Jembatan Per Tahun</p>
            </div>
