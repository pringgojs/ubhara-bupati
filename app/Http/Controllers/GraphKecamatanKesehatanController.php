...
class GraphKecamatanKesehatanController extends Controller
{
    //
    ...
    public function jenisfasyankes($kecamatan_id){
    ...
    public function jenisnakes($kecamatan_id){
        $query = "SELECT kesehatan_polis.nama as poli, count(tenaga_kesehatans.kesehatan_poli_id) as count_nakes
            ...
            LEFT JOIN desas ON fasyankes.desa_id = desas.id
            WHERE desas.kecamatan_id = $kecamatan_id
            AND kesehatan_polis.nama NOT LIKE '%PUSKESMAS%'
    ...
    public function fasyankesperdesa($kecamatan_id){
    ...
    public function listfasyankes($kecamatan_id){
        $fasyankes = Fasyankes::leftJoin('desas','fasyankes.desa_id', 'desas.id')
