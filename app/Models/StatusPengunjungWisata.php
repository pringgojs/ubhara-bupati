...
class StatusPengunjungWisata extends Model
{
    use HasFactory, SoftDeletes;
    protected $table = 'status_pengunjung_wisata';
    protected $dates = ['deleted_at']; 

    public static function addStatusPengunjungWisata($content, $tanggal_data){
        ...
        $sj = StatusPengunjungWisata::insertFromContent($data->id, $content, $tanggal_data);
        $data->status_dipakai = $sj->id;
        $data->save();
    }

    public static function insertFromContent($id, $content, $tanggal_data){
        $sj = new StatusPengunjungWisata;
