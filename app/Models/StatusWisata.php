...
class StatusWisata extends Model
{
    use HasFactory, SoftDeletes;
    protected $table = 'status_wisata';
    protected $dates = ['deleted_at']; 

    public static function addStatusWisata($content, $tanggal_data){
        ...
        $sj = StatusWisata::insertFromContent($data->id, $content, $tanggal_data);
