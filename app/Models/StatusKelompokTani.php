...
class StatusKelompokTani extends Model
{
    use HasFactory, SoftDeletes;
    protected $table = 'status_kelompok_tani';
    protected $dates = ['deleted_at']; 

    public static function addStatusKelompokTani($content, $tanggal_data){
        ...
        $sj = StatusKelompokTani::insertFromContent($data->id, $content, $tanggal_data);
        $data->status_dipakai = $sj->id;
        $data->save();
    }

    public static function insertFromContent($id, $content, $tanggal_data){
        $sj = new StatusKelompokTani;
